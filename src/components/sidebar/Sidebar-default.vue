    ...
    <div class="mb-5 mb-lg-8" id="kt_sidebar_body">
      ...
      >
        ...
        <div class="timeline">
          ...
          <div
            class="timeline-item"
            v-for="(log, i) in $store.getters.allLogs"
            :key="i"
          >
            <!--begin::Timeline line-->
            ...
            <div class="timeline-content mt-n1">
              ...
              <div class="pe-3">
                ...
                <div class="fs-5 text-white fw-bold mb-2">
                  {{ log.message }}
                  <span class="text-primary">{{ log.modal_name }}</span>
                </div>
                <!--end::Title-->
                <!--begin::Description-->
                <div class="d-flex align-items-center mt-1 fs-6">
                  ...
                  <!--end::Info-->
                  <div class="text-success fs-7 fw-bolder">
                    {{ log.created_by }}
                  </div>
                </div>
                <!--end::Description-->
