  ...
  <div class="launcher">
    <div class="d-flex flex-column flex-column-fluid mb-5 mb-lg-10">
      ...
      <div class="row g-7 w-xxl-850px">
        <!--begin::Brand-->
        <div
          class="d-flex align-items-center justify-content-xxl-center justify-content-between pt-10 pt-xxl-0 mb-10 mb-xxl-0 h-xxl-225px"
        >
          <!--begin::Logo-->
          <Logo></Logo>
          <!--end::Logo-->
          ...
          <div
            class="btn btn-icon btn-active-color-primary w-30px h-30px d-xxl-none me-4 ms-n15"
        ...
        <div class="col-xxl-7">
          ...
          <!--begin::Card-->
          <div
            class="card border-0 shadow-none min-h-200px"
          ...
          >
            ...
            <div class="card-body d-flex flex-center flex-wrap">
              ...
              >
                <!--begin::Heading-->
                <h3 class="text-gray-900 fw-boldest text-uppercase mb-5">
                  Quick Guide
                </h3>
                <!--end::Heading-->
                <!--begin::List-->
                <div class="text-gray-800 mb-5 text-center text-md-start">
                  Explore our powerful <br />documentation
                </div>
                <!--end::List-->
                <!--begin::Link-->
                <a
                  href="/metronic8/demo10/../demo10/documentation/getting-started.html"
    ...
    >
      ...
      <div class="mb-5 mb-lg-8" id="kt_sidebar_body">
        ...
        <div
          ...
          data-kt-scroll-wrappers="#kt_page, #kt_sidebar, #kt_sidebar_body"
          ...
          <div class="timeline">
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-content mb-10 mt-n1">
                ...
                <div class="pe-3 mb-5">
                  <!--begin::Title-->
                  <div class="fs-5 fw-bold mb-2 text-white">
                    Created 2 new tasks in "Development"
                  </div>
                  <!--end::Title-->
                  <!--begin::Description-->
                ...
                <div class="pb-5">
                  ...
                  <div class="d-flex flex-stack border rounded px-7 py-3">
                    ...
                    <a
                      href="#"
                      class="fs-5 text-white text-hover-success fw-bold w-375px"
                    ...
                    <a
                      href="#"
                      class="btn btn-sm btn-hover-rise text-white bg-white bg-opacity-10"
                      >View</a
                    >
                    <!--end::Action-->
                  </div>
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-content mb-10 mt-n2">
                ...
                <div class="pe-3">
                  <!--begin::Title-->
                  <div class="fs-5 text-white fw-bold mb-2">
                    2 new entries in "Landing Page"
                  </div>
                  <!--end::Title-->
                  <!--begin::Description-->
                  <div class="d-flex align-items-center mt-1 fs-6">
                    ...
                    <!--end::Info-->
                    <a href="#" class="text-success fs-7 fw-bolder"
                      >Adam Williams</a
                    >
                  </div>
                  <!--end::Description-->
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-content mb-10 mt-n1">
                ...
                <div class="mb-5 pe-3">
                  ...
                  <a
                    href="#"
                    class="fs-5 fw-bold text-white text-hover-success mb-2"
                  ...
                  <div class="d-flex align-items-center mt-1 fs-6">
                    ...
                    <!--end::Info-->
                    <!--begin::User-->
                    <a href="#" class="text-success fs-7 fw-bolder">You</a>
                    <!--end::User-->
                  </div>
                  <!--end::Description-->
                </div>
                    ...
                    <div class="d-flex align-items-center me-2">
                      ...
                      <div class="d-flex flex-stack">
                        ...
                        <div class="d-flex flex-column me-2">
                          ...
                          <a
                            href="#"
                            class="fs-7 text-white text-hover-success fw-bolder"
                            >App Guidelines</a
                          >
                          <!--end::Desc-->
                          <!--begin::Number-->
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-content mb-10 mt-n2">
                ...
                <div class="pe-3">
                  <!--begin::Title-->
                  <div class="fs-5 text-white fw-bold mb-2">
                    <a href="#" class="text-success">KTApp.js</a>&#160;has new
                    merged into Master
                  </div>
                  <!--end::Title-->
                  <!--begin::Description-->
                    ...
                    <div class="d-flex align-items-center me-2">
                      ...
                      <div class="d-flex flex-stack">
                        ...
                        <div class="d-flex flex-column me-2">
                          ...
                          <!--end::Desc-->
                          <!--begin::Number-->
                          <div class="text-gray-400">Ref: #ert-78</div>
                          <!--end::Number-->
                        </div>
                        <!--end::Info-->
                      </div>
      ...
      <div class="text-center" id="kt_sidebar_footer">
        <!--begin::Link-->
        <a
          href="../../demo10/dist/pages/profile/activity.html"
